...
const PlanningView = () => {
    const { createPlanFromSchedule, loadPlan, loadPlanQueue, setCurrentPlanId, setPlanningStateToLoad, savedPlans, currentPlanId, planningStateVersion, planningStateToLoad, lineTemplates, floaters, workerRegistry, persistStateKey, updatePlanPlanningState, planningState: contextPlanningState } = useData();
    ...
    }, [planningStateVersion, planningStateToLoad, setPlanningStateToLoad, contextPlanningState]);
